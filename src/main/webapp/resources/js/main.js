    ...
    $.ajax({
        ...
        success: function (data) {
            data.forEach(function (item, i, data) {
                ...
                $("#carusel_photo #lightSlider").append("<li class='lslide' style='width: 450px; margin-right: 10px;' data-thumb='" + item.thumbnailImageUrl + "'>"+
...
document.getElementById('b').onclick = function() {
    document.getElementById('v').appendChild("<li> 'ADANA '<\li>")
}
